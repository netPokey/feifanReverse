# 8 (v8) — CAN ID 逐位解析（TESLA_CAN_DECODE_PERID）

> 固件 `8 (v8)`（77824 B / 0x13000）。**自动生成**：`FULL=1 scripts/gen_perid.py`。
> 锚点：分发表 `0x0800cd62` · signal_state `0x0800029c` · 0xB0打包器 `0x0800bb28` · 复位 `0x080106d4`。
