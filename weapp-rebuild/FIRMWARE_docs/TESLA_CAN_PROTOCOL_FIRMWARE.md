...
| 控制帧 ID | 改写函数 | 改写位 | 备注 |
|-----------|---------|--------|------|
| 0x21c (540) | 0x08007c16 | D0=0x0a, D6 计数器, D7 CRC | re-sign 重签名 |
| 0x21c (540) | 0x08007c7c | D1, D3, D5 | 另一阶段 |
| 0x0a9 (169) | 0x08007ba4 | D2=0x30, D1, D0 | |
| 0x189 (393) | 0x08007d04 | D0, D3=0x2 | |
| 0x68c (1676) | 0x08007d48 | — | |
| 0x3a1 (929) | 0x08007d5c | — | |
| 0x37a (890) | (0x08007d 区) | — | |
| 0x3b0 (944) | (0x08007d 区) | — | |
...
> 剩余 ~6 个 gp 触发点（0x08006xxx 控制子系统）触发状态+改写位已知，确切 ID 依运行时上下文（最末长尾）。
